...
- keep `LINKEDIN_ASSISTANT_ACTIVITY_DELIVERY_LEASE_SECONDS` at or above `LINKEDIN_ASSISTANT_ACTIVITY_DELIVERY_TIMEOUT_SECONDS + LINKEDIN_ASSISTANT_ACTIVITY_CLOCK_SKEW_SECONDS`
- keep `LINKEDIN_ASSISTANT_ACTIVITY_WATCH_LEASE_SECONDS` above `LINKEDIN_ASSISTANT_ACTIVITY_CLOCK_SKEW_SECONDS`
- use `LINKEDIN_ASSISTANT_ACTIVITY_MAX_EVENT_QUEUE_DEPTH` to absorb webhook outages; when the queue is full the poller pauses new watch polling until deliveries drain
