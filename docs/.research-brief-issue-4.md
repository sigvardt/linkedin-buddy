...
- `packages/cli/src/bin/linkedin.ts` and `packages/mcp/src/bin/linkedin-buddy-mcp.ts` call runtime service methods directly; there is no intermediate selector abstraction layer
