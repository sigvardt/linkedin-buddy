...
async function handleProfilePrepareUpdatePublicProfile(
  ...
  try {
    ...
    const customProfileUrl = readString(args, "customProfileUrl", "");
      ...
      },
      {
        ...
        inputSchema: {
          ...
          properties: withCdpSchemaProperties({
            ...
            industry: {
              type: "string",
              description: "Optional new primary industry / professional category."
            },
            operatorNote: {
              type: "string",
              description: "Optional note attached to the prepared action."
      ...
      },
      {
        ...
        inputSchema: {
          ...
          properties: withCdpSchemaProperties({
            ...
            vanityName: {
              type: "string",
              description: "Preferred custom public profile slug, or a full LinkedIn profile URL."
            },
            customProfileUrl: {
              type: "string",
              description: "Alias for vanityName, primarily for profile-seeding compatibility."
            },
            publicProfileUrl: {
              type: "string",
              description: "Alias for vanityName when passing the full public profile URL."
            },
            operatorNote: {
              type: "string",
              description: "Optional note attached to the prepared action."
