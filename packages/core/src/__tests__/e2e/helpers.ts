...
export const MCP_TOOL_NAMES = {
  ...
  analyticsSearchAppearances: LINKEDIN_ANALYTICS_SEARCH_APPEARANCES_TOOL,
  authWhoami: LINKEDIN_AUTH_WHOAMI_TOOL,
  articlePrepareCreate: LINKEDIN_ARTICLE_PREPARE_CREATE_TOOL,
  articlePreparePublish: LINKEDIN_ARTICLE_PREPARE_PUBLISH_TOOL,
  activityDeliveriesList: LINKEDIN_ACTIVITY_DELIVERIES_LIST_TOOL,
  activityEventsList: LINKEDIN_ACTIVITY_EVENTS_LIST_TOOL,
  activityPollerRunOnce: LINKEDIN_ACTIVITY_POLLER_RUN_ONCE_TOOL,
  activityWatchCreate: LINKEDIN_ACTIVITY_WATCH_CREATE_TOOL,
  activityWatchList: LINKEDIN_ACTIVITY_WATCH_LIST_TOOL,
  activityWatchPause: LINKEDIN_ACTIVITY_WATCH_PAUSE_TOOL,
  activityWatchRemove: LINKEDIN_ACTIVITY_WATCH_REMOVE_TOOL,
  activityWatchResume: LINKEDIN_ACTIVITY_WATCH_RESUME_TOOL,
  activityWebhookCreate: LINKEDIN_ACTIVITY_WEBHOOK_CREATE_TOOL,
  activityWebhookList: LINKEDIN_ACTIVITY_WEBHOOK_LIST_TOOL,
  ...
  eventsPrepareRsvp: LINKEDIN_EVENTS_PREPARE_CREATE_TOOL,
  LINKEDIN_EVENTS_PREPARE_RSVP_TOOL,
  ...
  groupsPrepareJoin: LINKEDIN_GROUPS_PREPARE_CREATE_TOOL,
  LINKEDIN_GROUPS_PREPARE_JOIN_TOOL,
  ...
  assetsGenerateProfileImages: LINKEDIN_ASSETS_GENERATE_PROFILE_IMAGES_TOOL,
  companyPrepareFollow: LINKEDIN_COMPANY_PREPARE_FOLLOW_TOOL,
  companyPrepareUnfollow: LINKEDIN_COMPANY_PREPARE_UNFOLLOW_TOOL,
  companyView: LINKEDIN_COMPANY_VIEW_TOOL,
  inboxArchiveThread: LINKEDIN_INBOX_ARCHIVE_THREAD_TOOL,
  inboxMarkUnread: LINKEDIN_INBOX_MARK_UNREAD_TOOL,
  inboxMuteThread: LINKEDIN_INBOX_MUTE_THREAD_TOOL,
  ...
  inboxPrepareReact: LINKEDIN_INBOX_PREPARE_REACT_TOOL,
  inboxUnarchiveThread: LINKEDIN_INBOX_UNARCHIVE_THREAD_TOOL,
  profileView: LINKEDIN_PROFILE_VIEW_TOOL,
  profileViewEditable: LINKEDIN_PROFILE_VIEW_EDITABLE_TOOL,
  profilePrepareUpdateSettings: LINKEDIN_PROFILE_PREPARE_UPDATE_SETTINGS_TOOL,
  profilePrepareUpdatePublicProfile:
    LINKEDIN_PROFILE_PREPARE_UPDATE_PUBLIC_PROFILE_TOOL,
  profilePrepareRemoveSectionItem:
    LINKEDIN_PROFILE_PREPARE_REMOVE_SECTION_ITEM_TOOL,
  profilePrepareUpdateIntro: LINKEDIN_PROFILE_PREPARE_UPDATE_INTRO_TOOL,
  profilePrepareUpsertSectionItem:
    LINKEDIN_PROFILE_PREPARE_UPSERT_SECTION_ITEM_TOOL,
  ...
  profilePrepareRequestRecommendation:
    LINKEDIN_PROFILE_PREPARE_REQUEST_RECOMMENDATION_TOOL,
  profilePrepareWriteRecommendation:
    LINKEDIN_PROFILE_PREPARE_WRITE_RECOMMENDATION_TOOL,
  ...
  membersPrepareBlock: LINKEDIN_MEMBERS_PREPARE_BLOCK_TOOL,
  membersPrepareUnblock: LINKEDIN_MEMBERS_PREPARE_UNBLOCK_TOOL,
  membersPrepareReport: LINKEDIN_MEMBERS_PREPARE_REPORT_TOOL,
  newsletterList: LINKEDIN_NEWSLETTER_LIST_TOOL,
  ...
  feedPrepareRepost: LINKEDIN_FEED_PREPARE_REPOST_TOOL,
  feedPrepareShare: LINKEDIN_FEED_PREPARE_SHARE_TOOL,
  feedSavePost: LINKEDIN_FEED_SAVE_POST_TOOL,
  feedUnsavePost: LINKEDIN_FEED_UNSAVE_POST_TOOL,
  feedPrepareRemoveReaction: LINKEDIN_FEED_PREPARE_REMOVE_REACTION_TOOL,
